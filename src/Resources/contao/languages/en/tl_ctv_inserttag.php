...
foreach (['ctvDatei', 'ctvFormat', 'ctvListe', 'ctvSpalten', 'ctvStand', 'ctvStandAus', 'ctvRunden', 'ctvMannschaftswahl', 'ctvMannschaftSpieler', 'ctvKreuzKurz', 'ctvDatum', 'ctvHinweise', 'ctv_legend', 'ctv_spalten_legend', 'ctv_runden_legend', 'ctv_mannschaft_legend', 'ctv_hinweis_legend'] as $feld) {
