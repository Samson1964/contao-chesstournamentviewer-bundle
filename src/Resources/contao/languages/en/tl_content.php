...
$GLOBALS['TL_LANG']['tl_content']['ctvStandAus'] = ['Hide "Standings after round" line', 'Suppresses the note above the output when an earlier round is chosen — for instance because the element headline already names the round.'];
