...
$GLOBALS['TL_LANG']['tl_content']['ctvUeberschriftenAus'] = ['Hide automatic headlines', 'Suppresses both headlines the viewer adds by itself: "Standings after round 4" above the output and "Round 1", "Round 2" above the tables. Useful where the round is already named elsewhere — in the element headline or in the text around an insert tag.'];
$GLOBALS['TL_LANG']['tl_content']['ctvMannschaftswahl'] =['Teams', 'Shows only the matches of these teams, including their opponents. Without a selection all are shown.'];
$GLOBALS['TL_LANG']['tl_content']['ctvRundenkopfAus'] = ['Hide round headlines', 'Suppresses the headlines "Round 1", "Round 2" above the tables — for instance when the round is already named in the element headline or in the text around an insert tag.'];
