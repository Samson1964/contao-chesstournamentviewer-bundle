...
$GLOBALS['TL_LANG']['tl_content']['ctvUeberschriftenAus'] = ['Automatische Überschriften ausblenden', 'Unterdrückt beide Überschriften, die der Betrachter von sich aus setzt: „Stand nach Runde 4" über der Ausgabe und „Runde 1", „Runde 2" über den Tabellen. Gebraucht wird das, wo die Runde schon anderswo steht — in der Überschrift des Elements oder im Text um einen Inserttag herum.'];
$GLOBALS['TL_LANG']['tl_content']['ctvMannschaftswahl'] =['Mannschaften', 'Zeigt nur die Wettkämpfe dieser Mannschaften, mit ihren Gegnern. Ohne Auswahl erscheinen alle.'];
$GLOBALS['TL_LANG']['tl_content']['ctvRundenkopfAus'] = ['Rundenüberschriften ausblenden', 'Unterdrückt die Überschriften „Runde 1", „Runde 2" über den Tabellen — etwa wenn die Runde schon in der Überschrift des Elements oder im Text um einen Inserttag herum steht.'];
...
$GLOBALS['TL_LANG']['tl_content']['ctv_ueberschrift_legend'] = 'Überschriften';
